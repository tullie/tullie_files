...
hi clear
syntax reset
let g:colors_name = "tullie-colors"
...
call <sid>hi("Comment",      s:gui00, "", s:cterm00, "", "none")
...
call <sid>hi("Function",     s:gui03, "", s:cterm03, "", "none")
...
call <sid>hi("Statement",    s:gui04, "", s:cterm04, "", "none")
" call <sid>hi("StorageClass", s:gui07, "", s:cterm07, "", "none")
call <sid>hi("String",       s:gui02, "", s:cterm02, "", "none")
